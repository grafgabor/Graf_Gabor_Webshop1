        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a id="nav_termek_list" class="nav-link" href="?oldal=termek_list">Fő oldal</a>
                    </li>
                    <?php if (isset($_SESSION['felhasznalo_nev'])) : ?>
                        <li class="nav-item">
                            <a id="nav_termek_insert" class="nav-link" href="?oldal=termek_insert">termék felvétele</a>
                        </li>
                    <?php endif; ?>
                </ul>
